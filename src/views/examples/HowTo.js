                            ...
                            <div className="col-12"></div>
                                ...
                                <blockquote className='blockquote'>
                                    ...
                                    <ol>
                                        ...
                                        <li><span style={{ fontWeight: 'bold', textDecoration: 'underline'}}>Note: The AI-generated SOAP note and Insights should be used as SUGGESTIONS to help with notes and not a final end all be all copy</span></li>
                                    </ol>
                                </blockquote>
                            </div>
                        </div>
